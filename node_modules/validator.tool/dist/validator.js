...
(function (f) {
    ...
    */
     ...
     */
        ...
        // 自加
        username: /^(?!\d+$)(?![a-zA-Z]+$)[a-zA-Z0-9]{6,16}$/,
    ...
    var _testHook = {
        ...
        // 验证 数字+ 字母
        is_username: function (field) {
            return regexs.username.test(backVal(field));
        },
        //验证密码 必须大写+小写字母 + 数字 8-12
        is_pwd: function (field) {
            return regexs.pwd.test(backVal(field));
        },
        // 验证合法 ip 地址
